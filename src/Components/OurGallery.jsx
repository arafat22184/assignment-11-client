...
//   return (
//     <section
//       className="bg-slate-950 py-20 px-4 text-white"
//       id="gallery"
//       ref={ref}
//     >
...
//         >
//           <h2 className="text-4xl md:text-5xl font-extrabold bg-gradient-to-r from-blue-400 via-cyan-300 to-purple-400 bg-clip-text text-transparent mb-4 pb-4">
//             <Typewriter
...
//             Discover a visual journey through lifestyle, food, fitness, and joy.
...
const OurGallery = () => {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        {/* Sticky Title */}
        <div className="sticky top-0 z-30 bg-slate-950/90 backdrop-blur-lg py-4">
          <motion.div
